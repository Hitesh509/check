    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "joywebsolution.com", path: '/', icon: MailIcon },
                { text: "794 Francisco, CA 94102", path: '/', icon: MapPinIcon }
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    ...
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm text-slate-600">
                        CartIQ makes grocery shopping easier with smart scan-to-shop technology. Discover groceries, gadgets, and essentials—all in one place.
                        </p>
                    </div>
