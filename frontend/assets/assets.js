...
export const productDummyData = [
    {
        id: "prod_1",
        name: "Fresh Farms Apple(1pcs)",
        description: "Handpicked Royal Gala apples known for their sweet flavor, crisp texture, and natural shine. Perfect for fresh snacking or fruit salads. Rich in antioxidants and dietary fiber to support a healthy lifestyle.",
        mrp: 30,
        price: 25,
        images: [product_img1],
        category: "Fruits",
    ...
    },
    {
        id: "prod_2",
        name: "Banana (1pcs)",
        description: "Naturally ripened Cavendish bananas rich in potassium, vitamins, and energy — ideal for breakfast, smoothies, and post-workout nutrition. Freshly packed for maximum quality and taste.",
        mrp: 15,
        price: 10,
        images: [product_img2],
        storeId: "seller_1",
    ...
    {
        id: "prod_3",
        name: "PepsiCo Pepsi 500ml Bottle",
        description: "Refreshing carbonated soft drink with a bold cola flavor that energizes you instantly. Best served chilled with meals or snacks for a fizzy burst of joy anytime, anywhere.",
        mrp: 45,
        price: 40,
        images: [product_img3],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "High-quality ruled notebook with smooth 70 GSM paper and attractive cover design. Ideal for students and professionals for note-taking, journaling, or writing assignments.",
        mrp: 70,
        price: 60,
        images: [product_img4],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Enriched with calcium and fluoride, Colgate Strong Teeth helps strengthen teeth from within and provides all-day freshness and protection against cavities and germs.",
        mrp: 75,
        price: 65,
        images: [product_img5],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Nourishing shampoo infused with Keratin Actives that repair damaged hair, leaving it soft, smooth, and visibly healthy after every wash. Suitable for daily use and all hair types.",
        mrp: 210,
        price: 180,
        images: [product_img6],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Premium long-grain basmati rice with a rich aroma and fluffy texture. Perfect for biryanis, pulao, or everyday meals. Each grain is aged and naturally processed for superior quality.",
        mrp: 120,
        price: 90,
        images: [product_img7],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Soft, fresh, and fluffy white sandwich bread baked to perfection. Ideal for sandwiches, toast, and breakfast snacks. Made with high-quality wheat flour for great taste.",
        mrp: 45,
        price: 35,
        images: [product_img8],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Pure and pasteurized toned milk from Amul, rich in protein and calcium. Ensures wholesome nutrition and is perfect for tea, coffee, and daily consumption.",
        mrp: 32,
        price: 28,
        images: [product_img9],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Crispy and light potato chips seasoned with classic salt for the perfect snack time crunch. Great for parties, picnics, or on-the-go munching.",
        mrp: 25,
        price: 20,
        images: [product_img10,hero_product_img1,hero_product_img2],
        storeId: "seller_1",
        inStock: true,
        store: dummyStoreData,
        category: "Snacks",
    ...
    },
    {
        ...
        description: "Trusted germ protection soap from Dettol that deeply cleanses while keeping your skin healthy, fresh, and protected against 99.9% of germs and bacteria.",
        mrp: 40,
        price: 35,
    ...
    {
        id: "prod_12",
        name: "Tata Tea Gold 250g Pack",
        description: "Rich blend of strong Assam tea leaves and gently rolled buds that offer a perfect balance of strength, taste, and aroma in every cup. Perfect for your morning refreshment.",
        mrp: 160,
        price: 140,
